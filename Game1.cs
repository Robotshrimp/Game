...
namespace GameJom
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Text = Content.Load<Texture2D>("Bogos Font");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            MaiCamera.draw(new Rectangle(0, 0, 1000, 1000), Text);
            ...
            */
            ...
            TextFont test = new TextFont(Text1);


            PrintManager printTest = new PrintManager(test, 20, Color.White, new Point(240, 300), MainCamera);
            printTest.Print(test, "Bobama 10 $%#!^&*()", new Point(1000, 1000));

            Button start = new Button(new AutomatedDraw(), printTest, new Point(300, 300), "start", GameState == 1);
            start.ButtonUpdate(test);
            if (start.pressedLeft)
            {
                GameState = 2;
            }
            Button bobama = new Button(MainCamera, printTest, new Point(-300, -300), "bobama", GameState == 2);
            bobama.ButtonUpdate(test);
            if (bobama.pressedLeft)
            {
                GameState = 1;
            }
            Menu menu = new Menu(new AutomatedDraw(), printTest, new string[] { "bruh", "obamna", "orion did nothing wrong", "poopy head", "1234567890" }, new Rectangle(0, 0, 1000, 1000), 100, test, Text2, Text3, true);
            menu.MenuUpdate();
