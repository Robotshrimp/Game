...
namespace GameJom
{
    public class PrintManager
    {
        ...
        public void Print(AutomatedDraw DrawParam, TextFont Font, string Text, Point PrintLocation)
        {
        ...
        public void Print(string Text, Point PrintLocation)
        {
            Print(font, Text, PrintLocation);
        }
    ...
    public class TextFont
    {
        ...
        public Rectangle letterFinder(char Character)
        {
            ...
            switch (Character)
            {
                ...
                case '!': character = new Point(25, capital); break;
